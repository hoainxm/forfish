...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    /*  GHI DẤU HẠNG NGAY TẠI ĐĂNG NHẬP (chủ dự án 2026-08-31: token lúc đăng
        ...
        `writePremiumMark` cũng bắn TIER_EVENT nhưng lúc này còn ở /login, hook
        use-tier của app chưa mount — điểm ăn tiền là DẤU đã nằm trong máy để
        featureAccessDecision dùng khi app mở. */
