...
// Webhook SDWork provision tài khoản với mật khẩu mặc định (123456) + đặt cờ
 ...
 *  đăng nhập/đăng ký (đề phòng nhầm tài khoản), và mọi API (refresh phiên +
 *  đẩy mật khẩu mới sang SDWork). */
const ALLOW_PREFIXES = ["/doi-mat-khau", "/login", "/dang-ky", "/api"];
