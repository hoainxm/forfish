-- SDFish — APPLY TẤT CẢ migration chờ (0020-0027) lên prod znzgugvfhgmiszqgjulk
-- Chạy CẢ khối trong Supabase → SQL Editor. Idempotent (chạy lại an toàn).
-- Sinh 2026-07-30 từ supabase/migrations/.
