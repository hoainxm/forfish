-- 0041 — ĐÃ LƯU Ở ĐÂU, ĐỦ CHỖ KHÔNG, ĐÃ CHẮC CHẠY OFFLINE CHƯA
--
...
--
-- 0040 đã chở về MỘT con số tổng (`storage_used_mb`). Số đó KHÔNG trả lời được
...
--   ② dữ liệu tới ngày nào  → `data_until` / `data_until_web` (đã có, 0036/0038)
...
-- Theo TỪNG MÁY (0033) — đổi điện thoại vẫn tra được máy cũ, và để so iOS/Android.
