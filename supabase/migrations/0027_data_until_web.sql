-- 0027 — DỮ LIỆU TỚI NGÀY NÀO: TÁCH KHO BẢN CÀI VỚI KHO WEB
--
...
--
-- LỖI ĐÃ SỬA — /quan-tri đang mô tả NHẦM KHO. Cột `data_until` (0025) được ghi
...
--   · `data_until`      kho BẢN CÀI (giữ nguyên tên của 0025 — chỉ thu hẹp lại
...
comment on column public.customers.data_until_web is
  'Ngày xa nhất dữ liệu trong kho WEB còn phủ tới. Tách khỏi data_until (kho BẢN CÀI) vì trên iOS hai kho RIÊNG — xem 0027.';

comment on column public.customers.data_until is
  'Ngày xa nhất dữ liệu trong kho BẢN CÀI còn phủ tới — kho sẽ ra khơi. CHỈ nhịp từ bản cài mới ghi cột này (thu hẹp lại từ 0027).';

-- Sổ theo từng máy (0022/0025) cũng tách y vậy, để đổi điện thoại vẫn tra được
