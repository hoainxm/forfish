-- 0039 — MỘT TÀI KHOẢN CHỈ ĐƯỢC MỘT CHUỖI SỐNG (chặn ở tầng DB)
--
...
--
-- Thay luôn index thường của 0037 — index unique này phục vụ đúng cùng câu truy
...
comment on index public.device_tokens_one_live_idx is
  'Mot SDT nhieu nhat MOT chuoi song. Rang buoc that cua luat 1-tai-khoan-1-may; xem 0039.';
