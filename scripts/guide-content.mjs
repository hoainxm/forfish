...
export const prose = {
  intro: {
    ...
    blocks: [
      ...
      { note: "<b>Không đăng nhập vẫn xem được</b> giá cá, gió sóng, danh bạ cảng, chợ tin mua–bán. Những thứ riêng của bà con — giấy tờ, thuyền viên — thì phải đăng nhập, để người khác cầm máy cũng không xem được." },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Ngoài khơi mất sóng thì sao?", a: "Những gì đã ghi trong máy — giấy tờ, thuyền viên, nhắc bảo dưỡng — vẫn xem được. Trên màn Ra khơi, <b>chỗ nào đã mở lúc còn mạng</b> thì app giữ lại bản đồ và số gió sóng, có ghi 'đã lưu tới ngày…' (bản lưu không chấm điểm biển, không có mưa dông). Giá cá, tin bão, và chỗ chưa từng mở thì cần có mạng mới xem được." },
      { q: "Sao dự báo cá với thời tiết dài ngày bắt có tài khoản nâng cao?", a: "<b>Dự báo cá</b> (chỗ có khả năng có cá theo loài) và <b>thời tiết quá 3 ngày</b> là tính năng của <b>tài khoản nâng cao (premium)</b>. Gió sóng 3 ngày, tin bão, giá cá, giấy tờ… thì mọi tài khoản đều dùng. Muốn mở premium: <b>gọi SDVICO</b> (Tàu của tôi → Dịch vụ → Gọi SDVICO), không phải trả tiền trong app — bên SDVICO mở giúp, mở xong đăng nhập lại là thấy." },
      ...
      { q: "Tôi có mấy tàu, ghi chung hay riêng?", a: "Riêng theo tàu: giấy tờ, bảo dưỡng. Chung cả chủ tàu: sổ bạn thuyền. Đổi tàu bằng nút chọn tàu ngay dưới phần đầu màn." },
...
export const screens = [
  {
    ...
    marks: [
      ...
      { sel: '[data-tour="chon-tau"]', label: "Chọn tàu", desc: "Hiện tàu đang xem. Bấm để đổi tàu khác hoặc thêm tàu mới. Giấy tờ, bảo dưỡng đều tính theo tàu đang chọn ở đây — chọn nhầm tàu là xem nhầm sổ." },
      ...
      { sel: '[data-tour="bon-viec"] a[href="/tau"]', label: "Ô Tàu cá", desc: "Giấy tờ tàu, dịch vụ và đồ đã mua của SDVICO, danh mục sản phẩm." },
      { sel: '[data-tour="bon-viec"] a[href="/nguoi"]', label: "Ô Bạn thuyền", desc: "Hồ sơ thuyền viên, chứng chỉ, bảo hiểm, sổ ứng tiền." },
      { sel: '[data-tour="bon-viec"] a[href="/tien"]', label: "Ô Giao dịch", desc: "Giá cá, ai đang cần mua, chợ tin mua–bán." },
  ...
  },
  {
    ...
    url: "/tau?tab=giay-to",
    lead: "Ba tab trên đầu màn: Giấy tờ, Dịch vụ, Sản phẩm.",
    marks: [
      { sel: '[data-tour="tab-giay-to"]', label: "Tab Giấy tờ", desc: "Tủ giấy tờ của tàu đang chọn — app nhắc trước khi hết hạn." },
      { sel: '[data-tour="tab-dich-vu"]', label: "Tab Dịch vụ", desc: "Dịch vụ SDVICO, cước chờ đóng, nút gọi SDVICO, sổ nhắc bảo dưỡng." },
      { sel: '[data-tour="tab-san-pham"]', label: "Tab Sản phẩm", desc: "Đồ đã mua và hạn bảo hành + danh mục sản phẩm SDVICO." },
  ...
  },
  {
    ...
    url: "/nguoi",
    lead: "Ai đi tàu mình, giấy tờ tới đâu, có cảnh báo gì không.",
    marks: [
      { sel: '[data-tour="them-thuyen-vien"]', label: "Thêm bạn thuyền", desc: "Ghi tên, CCCD, số điện thoại, chứng chỉ, bảo hiểm và ngày hết hạn." },
    ],
    note: "Định danh bằng <b>CCCD</b>. Chủ tàu premium tra CCCD trước khi thuê thấy <b>cảnh báo đã được SDVICO kiểm duyệt</b> (nếu có). Bảo hiểm/chứng chỉ sắp hết hạn thì băng trên thẻ chuyển vàng, quá hạn thì đỏ. Sổ theo CHỦ TÀU, đổi tàu vẫn thấy đủ người.",
  },
  {
    id: "tien-giao-dich",
    title: "Màn Giao dịch",
    url: "/tien",
    lead: "Nắm giá trước khi vào bờ + chợ tin mua/bán. Không cần đăng nhập.",
    marks: [
      { text: "Giá cá", label: "Giá cá", desc: "Giá tham khảo theo tuần, kèm giá dầu DO." },
      { text: "Ai cần mua", label: "Ai cần mua / tin mua–bán", desc: "Chợ tin: ai đang cần mua loài gì, bao nhiêu; chủ tàu cũng đăng được tin bán — bấm để gọi." },
      { text: "Bán ở đâu", label: "Bán ở đâu", desc: "Vựa, đầu mối, doanh nghiệp thu mua theo vùng và theo loài, có số điện thoại." },
    ],
    note: "Khu Giao dịch nay gọn về đúng việc MUA–BÁN (giá + chợ tin + chỗ bán). Sổ lãi lỗ, công nợ, chia tiền chuyến đã bỏ.",
  },
  {
    id: "cang",
