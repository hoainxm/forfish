...
- **Ký hiệu trạm con nước = CỘT NƯỚC (2026-09-04, "đừng dùng hình tròn")**: cột trắng viền INK, mực nước đầy theo biên độ ngày, ruột **BLUE `#2b74c4`** (màu mới thứ 9 của bảng sprite; 3,77:1 nền biển · 3,49:1 với INK — cổng test) khi đang lên, **RED** khi đang xuống, **SLATE** khi đứng, mũi tên INK bên phải; trạm mô hình ruột kẻ sọc. `TIDE_STATION_COLOR` (nhãn) = đúng mã BLUE — một thứ, một màu. Kênh màu riêng: khác navy nhãn đảo, teal rạn, lục khu trú bão, lục phao phải luồng, magenta đèn, tím xác tàu. Nhãn cùng màu, halo trắng, Noto Sans Bold. Trong thẻ con nước: chip xu hướng **lên = t1, xuống = warn, đứng = field**; chấm đỉnh triều t1, chân triều warn — đỏ để dành cho vạch "bây giờ" và cảnh báo, không dùng cho nước ròng (nước ròng không phải hiểm hoạ).
