...
- **Chọn loài cá (39 loài, 2026-06-10)**: hàng chip nổi trên map, mỗi chip có **chấm màu riêng của loài**; "Mọi loài" + từng loài đang vụ. **Loài đang vụ Ở VÙNG ĐANG XEM xếp lên đầu + viền cam** ("loài bà con hay đánh ở vùng mình"), rồi nhóm theo `category`. Chọn loài thì heatmap + hồng tâm tô CHỈ theo màu loài đó. **Ưu tiên gần mình**: điểm nóng cộng thưởng theo khoảng cách tới chỗ xem / cảng nhà / điểm ghim (không bịa cá, chỉ xếp gần lên trước); thẻ cá có dòng "Điểm cá gần bạn nhất ~N hải lý hướng X". Chi tiết loài tại điểm chạm nằm trong sheet.
