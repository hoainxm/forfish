...
- **Chấm trạm con nước (2026-09-04)**: xanh dương `TIDE_STATION_COLOR` #1e5aa8 (5,4:1 trên nền biển, cổng test) viền trắng 2 px — kênh màu riêng: khác navy nhãn đảo về độ sáng, khác teal rạn / lục khu trú bão / magenta đèn / tím xác tàu. **Đặc = trạm đo, rỗng (trắng viền xanh) = trạm mô hình** — hình nói cùng một điều với chữ "ước tính" trong thẻ. Nhãn cùng màu, halo trắng, Noto Sans Bold. Trong thẻ con nước: chip xu hướng **lên = t1, xuống = warn, đứng = field**; chấm đỉnh triều t1, chân triều warn — đỏ để dành cho vạch "bây giờ" và cảnh báo, không dùng cho nước ròng (nước ròng không phải hiểm hoạ).
