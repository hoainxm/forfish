...
| `/login` | AUTH — **SĐT + mật khẩu (Đợt 1)** | `src/app/login/page.tsx` | `signInWithPassword` ({SĐT}@sdvico.local). KHÔNG email/OTP. Từ 2026-07-21 KHÔNG ép đổi mk lần đầu (cờ `must_change_password` chỉ còn khi bật thủ công) |
