...
| Nhật ký khai thác giấy, ghi gộp cuối chuyến ("hồi ký"), hay lệch với cân tại cảng | Ghi đúng từng mẻ không tốn thời gian, khớp eCDT khi bắt buộc (7/2026–1/2027) | Lộ trình nhật ký điện tử theo cỡ tàu (TT 81/2025); vì sao nhật ký sai = mất xác nhận nguồn gốc = mất giá bán | Nhật ký điện tử offline-first ghi theo mẻ (1 phút/mẻ, loài + GPS tự điền), tự tổng hợp về Mẫu 01, đồng bộ eCDT khi có sóng | 01, 03 |
| Nghe nói phải khai eCDT ra/vào cảng nhưng không rành thao tác (75% tàu chưa làm) | Khai đúng, đủ, nhanh tại cảng — không bị giữ tàu/từ chối bốc dỡ | Hướng dẫn từng bước theo đúng cảng hay cập; thời điểm phải thông báo trước khi cập/rời cảng | **Trợ lý eCDT**: wizard điền sẵn từ hồ sơ tàu, nhắc "sắp tới cảng — gửi thông báo ngay" theo GPS; **người nhà khai hộ từ bờ** | 03, 04 |
...
|---|---|---|---|
| A. ĐI BIỂN | sea-forecast (điểm đi biển), fishing-map (bản đồ ngư trường), trip-log (một phần) | — | geofence vùng biển (ranh ven bờ/lộng/khơi + chồng lấn nước ngoài); nhật ký mẻ lưới riêng tư; máy tính chuyến biển (tổn dự kiến/hòa vốn) |
| B. BÁN CÁ | price-board (giá theo loài tại cảng) | — | hồ sơ chuyến PDF/QR (chứng minh truy xuất cho người mua); chào bán Zalo 1 chạm |
| C. TIỀN NONG | trip-log (sổ lãi/lỗ chuyến biển) | sổ ứng tiền + máy tính chia tiền (trong crew module) | **sổ công nợ đa đối tượng** (đại lý dầu, nậu, ngân hàng); báo cáo lời/lỗ năm |
...
| E. GIẤY TỜ & TUÂN THỦ | document-vault (tủ giấy tờ + nhắc hạn), fines-lookup (tra mức phạt) | — | **checklist xuất bến tự sinh theo Lmax**; **trợ lý eCDT** (wizard + khai hộ từ bờ); **cảnh báo VMS** (mất kết nối, đếm ngược 6h/10 ngày); điểm rủi ro IUU |
