...
| B. BÁN CÁ | price-board (giá theo loài tại cảng), **trip-dossier (hồ sơ chuyến PDF in được)** | — | mã QR truy xuất xác minh trên hồ sơ (cần backend); chào bán Zalo 1 chạm |
| C. TIỀN NONG | trip-log (sổ lãi/lỗ chuyến biển), **trip-report (báo cáo lời/lỗ năm)**, **trip-estimator (ước tổn/hoà vốn)**, **debt-ledger (sổ công nợ đa đối tượng: đại lý dầu/nậu/ngân hàng)**, sổ ứng + máy chia tiền (crew module) | — | — (nhóm C đã phủ; nâng cấp sau: đối chiếu 2 bên, xuất bảng kê) |
...
| E. GIẤY TỜ & TUÂN THỦ | document-vault (tủ giấy tờ + nhắc hạn), fines-lookup (tra mức phạt), **departure-checklist (checklist xuất bến theo Lmax + đèn xanh-đỏ + NHẮC mốc eCDT/NKKT theo cỡ tàu ← lib/compliance)** | — | **cảnh báo VMS** (mất kết nối, đếm ngược 6h/10 ngày — cần nguồn VMS); điểm rủi ro IUU |
| F. VẬN HÀNH TÀU | supply-catalog (chợ vật tư), maintenance-reminders (nhắc bảo dưỡng), **trip-log "Lặp lại chuyến" (chép số tổn chuyến cũ làm nền chuyến mới)** | — | checklist chuẩn bị chuyến đầy đủ (số cây đá, lít dầu, danh sách bạn — mở rộng từ "Lặp lại chuyến") |
