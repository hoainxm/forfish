...
| E. GIẤY TỜ & TUÂN THỦ | document-vault (tủ giấy tờ + nhắc hạn), fines-lookup (tra mức phạt), **departure-checklist (checklist xuất bến tự sinh theo Lmax + đèn xanh-đỏ)** | — | **cảnh báo VMS** (mất kết nối, đếm ngược 6h/10 ngày — cần nguồn VMS); điểm rủi ro IUU; NHẮC mốc eCDT/NKKT (khai báo thật ⛔ ngoài phạm vi) |
