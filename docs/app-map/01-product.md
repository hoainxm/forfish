...
- **Gồm**: bản đồ ngư trường map-first (lớp hải đồ/vệ tinh + nhãn chủ quyền tiếng Việt), **dự báo vẽ động kiểu Windy** (lớp gió/sóng theo giờ 3 ngày, thanh thời gian + nút chạy), gió sóng theo điểm chạm 1–16 ngày, **lớp "Cá mùa này"** (vùng nào đang vụ cá gì — mùa vụ nhiều năm), dẫn đường tiết kiệm dầu.
