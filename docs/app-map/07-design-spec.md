...
ĐỔI NGHĨA BẬC "ĐỦ ĐỒ ĐI BIỂN" (chủ dự án chốt: "1 chiều thôi, web → PWA → tải; nếu không PWA thì nó cứ nằm ở Web để đảm bảo họ có PWA"): trước đây máy Android tải đủ dữ liệu TRONG TAB vẫn được lên chip xanh "Đủ đồ đi biển" và tụt khỏi danh sách đáng-gọi-điện dù chưa cài gì; nay chưa mở bản cài thì đứng lại ở "Chưa mở bản cài" (vàng) trên MỌI máy. Nhãn chip và khuôn chữ KHÔNG đổi — chỉ đổi điều kiện lên bậc. Không đổi nav/dock/route. -->
