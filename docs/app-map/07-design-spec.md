...
<!-- re-verified: 2026-07-30 — THANG MÀU MÂY bám opacity theo lượng mây (user, ảnh: "mây ít nhưng nhìn mờ cả bản đồ; tham khảo Windy"). SCALAR_RAMP.cloud đổi đường cong alpha: trước 25%→0,28 nên biển VN hay 20–40% mây khắp nơi phủ MÀN MỜ che địa hình dù trời quang. Nay đúng nguyên lý Windy — ít mây = gần TRONG (30%→0,04 · 55%→0,16), độ đục chỉ vọt lên khi trời nhiều mây (75%→0,38 · 90%→0,60 · 100%→0,82). Màu trắng-lam sạch giữ nguyên; alpha là NGUỒN DUY NHẤT (shader u_opacity=1, cả GL texture lẫn polygon fallback đọc chung scalarColor). Test cloud cập nhật (chặng cuối + ngưỡng ít-mây <0,1). -->
