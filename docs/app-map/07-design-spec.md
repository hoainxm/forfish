...
<!-- re-verified: 2026-07-29k — DOCK iOS 26 v3 (ảnh user bản cài 13:20 vẫn treo lưng chừng): bù vị trí --vvgap NAY CHỈ áp trong standalone (PWA cài) — dock tụt đúng phần hụt + đáy trang /ngu-truong nở theo cùng biến (sheet + thanh ngày + dock đi cùng nhau, hết khối trắng dưới). Safari thường: giữ hích-cuộn, không đo-rồi-dịch (bài học v2). Var 0 → giao diện y hệt cũ. -->
