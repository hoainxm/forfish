...
<!-- re-verified: 2026-07-30b — MÂY TRUNG TÍNH XÁM-TRẮNG (user: "mây nhiều kéo qua xanh, vô tình làm rõ vùng biển; nhiều mây phải đục/trắng hơn ít mây"). Bản 07-30 còn ánh LAM khúc giữa (55% [228,237,246]) → màn lam mờ đè biển lam làm NƯỚC ĐẬM/RÕ hơn, đọc nhầm là tô sáng biển. Nay MÂY chỉ MỘT biến = độ đục, màu R≈G≈B (30%→[244,245,246] a0,05 · 55%→[240,241,242] a0,18 · 75%→a0,42 · 90%→a0,66 · 100%→[250,250,251] a0,88): mây càng nhiều CÀNG ĐỤC+TRẮNG, ít mây gần trong. Test thêm guard "b−r ≤ 4" chống lam quay lại + chặng cuối 0,88. -->
